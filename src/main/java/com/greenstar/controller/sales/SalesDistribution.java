...
import com.greenstar.entity.sale.MNPSaleDetailView;
import com.greenstar.entity.sale.SDMonthlyFinalData;
import com.greenstar.entity.sale.SaleDetail;
...
public class SalesDistribution {
    @RequestMapping(value = "/distributeSales", method = RequestMethod.GET)
    @ResponseBody
    public String distributeSales(){

        PRDGroupOn prdgrpon = null;
        List<SDMonthlyFinalData> sdMonthlyFinalDataList = new ArrayList<>();
        sdMonthlyFinalDataList = (List<SDMonthlyFinalData>) HibernateUtil.getDBObjects("from SDMonthlyFinalData where PROVIDER_CODE is null and TRANSACTION_DATE like '%-MAR-21'");
     //   sdMonthlyFinalDataList = (List<SDMonthlyFinalData>) HibernateUtil.getDBObjects("from SDMonthlyFinalData where HUID=89287257");
        ...
        for(SDMonthlyFinalData sdMonthlyFinalData:sdMonthlyFinalDataList ){
            ...
            String queryFetchView = "from MNPSaleDetailView where HUID = '"+sdMonthlyFinalData.getHUID()+"'";

          //  List<MNPSaleDetailView> mnpSaleDetailViews = (List<MNPSaleDetailView>) HibernateUtil.getDBObjects(queryFetchView);

          //  MNPSaleDetailView mnpSaleDetailView = new MNPSaleDetailView();
...
//            saleDetail.setEXPIRY(sdMonthlyFinalData.getEXPIRY());
            ...
            saleDetail.setNET_QTY(sdMonthlyFinalData.getNET_QTY());
            saleDetail.setNET_VALUE(sdMonthlyFinalData.getNET_VALUE());
            ...
            String tehsil_id = HibernateUtil.getSingleString("SELECT MAX(tehsil_id) from BASE_TEHSIL_SNDPOP where sndpop_id = SUBSTR('"+sdMonthlyFinalData.getSNDPOP()+"',1,9) || SUBSTR('"+sdMonthlyFinalData.getDEPOT()+"',1,3) || '"+sdMonthlyFinalData.getTERRITORY()+"'");
